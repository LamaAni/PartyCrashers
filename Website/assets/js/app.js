  ...
  theaters.eachLayer(function (layer) {
    if (map.hasLayer(theaterLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/Cocktails.png"></td><td class="feature-name">' + layer.feature.properties.NAME + '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
      }
    }
  });
...
var theaters = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "assets/img/Cocktails.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
var groupedOverlays = {
  "Amenities": {
    "<img src='assets/img/Cocktails.png' width='24' height='28'>&nbsp;Cocktails": museumLayer,
    //"<img src='assets/img/Beer.png' width='24' height='28'>&nbsp;Beers": theaterLayer,
    //"<img src='assets/img/Wine.png' width='24' height='28'>&nbsp;Wine": wineLayer,
    //"<img src='assets/img/Food.png' width='24' height='28'>&nbsp;Food": foodLayer,
  },
  "Reference": {
    "Boroughs": boroughs,
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/Cocktails.png' width='24' height='28'>&nbsp;Theaters</h4>",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/Beer.png' width='24' height='28'>&nbsp;Museums</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  }, {
    name: "GeoNames",
